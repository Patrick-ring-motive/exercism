...
export const getListOfWagons = (...args) => args;
 ...
 */
export const fixListOfWagons = ({values}) => values.push(values.shift(),values.shift()) && values;
 ...
 */
export const correctListOfWagons = (ids, missingWagons) => [ids.values.shift(),...missingWagons,...ids.values];
 ...
 */
export const extendRouteInformation = (information, additional) => Object.assign(information,additional);
 ...
 */
export const separateTimeOfArrival = information => [information.timeOfArrival,Object.fromEntries(Object.entries(information).slice(0,-1))];